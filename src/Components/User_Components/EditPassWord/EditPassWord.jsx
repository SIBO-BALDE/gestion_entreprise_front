                ...
                <h4 style={{marginTop:'30px'}}>Nouveau mot de passe</h4>
                        <Form onSubmit={handleSubmit}>
                            <Form.Group>
                                ...
                                <FontAwesomeIcon icon={faLock} className="icon_login_content_middle mt-1" style={{color:'#004573'}}/>
                                <Form.Control 
                                    ...
                                    required
                                />
                                <span className="password_toggle_login_form2" onClick={togglePasswordVisibility} style={{color:'#004573'}}>
                            ...
                            <Form.Group>
                                ...
                                <Form.Control 
                                    ...
                                    required
                                />
                                <span className="password_toggle_login_form2" onClick={togglePasswordVisibilityConfirm} style={{color:'#004573'}}>
