  ...
  return (
    <div>
      ...
      <section className='mt-5'>
        ...
        <div className='objectif_content_flex mt-5' >
          <div >
          ...
          {/*  */}
          <div className="svg-frame content_animation2">
              <svg >
                <g id="out1">
                  ...
                  <path mask="url(#path-1-inside-1_111_3212)" stroke-miterlimit="16" stroke-width="2" stroke="#004573" d="M72 172C72 116.772 116.772 72 172 72C227.228 72 272 116.772 272 172C272 227.228 227.228 272 172 272C116.772 272 72 227.228 72 172ZM197.322 172C197.322 158.015 185.985 146.678 172 146.678C158.015 146.678 146.678 158.015 146.678 172C146.678 185.985 158.015 197.322 172 197.322C185.985 197.322 197.322 185.985 197.322 172Z"></path>
                </g>
              </svg>
          ...
          <div  style={{marginRight:'45px'}} >
            <div className="text-container mb-5" >
                <h1 style={{color:'#004573', marginBottom:'30px'}} className='text_design_header'>

                
        <span style={{  fontWeight: 'bold' }}>
          {/* Style will be inherited from the parent element */}
          <Typewriter
            words={['10 raisons de procéder à un feedback 360 degrés']}
            loop={true}
            cursor
            cursorStyle='_'
            typeSpeed={70}
