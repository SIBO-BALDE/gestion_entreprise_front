...
import { faBriefcase, faBullseye, faCheck, faCrosshairs, faQuestion, faSignsPost, faUsers } from '@fortawesome/free-solid-svg-icons';
        ...
        <Underline text='Pourquoi nous ?' />
          ...
          <div className='container contain-main-card-obj'>
            ...
            <div>
              ...
              {/* <div className='d-flex  '>
                              <div><ButtonDeco backgroundColor='#004573' /></div>
                              <div><p style={{textAlign:'justify'}}> L’art d’instaurer la confiance dans nos activités.</p></div>
              </div> */}
              {/* <div className='d-flex  '>
                              <div><ButtonDeco backgroundColor='#004573' /></div>
            ...
            <div className='content_animation1' >
              ...
              <div className='content_flex_midle_el'>
                  ...
                  <div className='content_main_midle_about3'>
                      <div className='content_midle_about3'>
                          <FontAwesomeIcon icon={faUsers} className='icon_comment_figure' style={{fontSize:'40px'}}  />
                      </div>
                  </div>
                  <div className='content_flex_midle_el_thirth'>
                      <FontAwesomeIcon icon={faSignsPost} />
          ...
          <div className='card-ojectif-main'>
           ...
           <div>
            ...
            {/* <div className='d-flex  '>
                            <div><ButtonDeco backgroundColor='#004573' /></div>
                            <div><p style={{textAlign:'justify'}}>La confiance reconnue a un impact direct sur l’éthique du travail</p></div>
            </div> */}
